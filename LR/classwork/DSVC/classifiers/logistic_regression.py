...
class LogisticRegression(object):
    ...
    def loss(self, X_batch, y_batch):
        ...
        loss = (-y_batch.T.dot(np.log(self.sigmoid(z))) - (1.0 - y_batch.T).dot(np.log(1.0 - self.sigmoid(z))))/X_batch.shape[0]
        grad = np.zeros_like(self.w)
        grad = X_batch.T.dot(self.sigmoid(z) - y_batch) /X_batch.shape[0]
        #########################################################################
        #                       END OF YOUR CODE                                #
        #########################################################################
        return loss,grad
